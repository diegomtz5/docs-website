...
* `https://otlp.nr-data.net:4318` with your New Relic OTLP endpoint (use `https://otlp.eu01.nr-data.net:4318` for EU region). For other endpoints and configuration options, see [Configure your OTLP endpoint](/docs/opentelemetry/best-practices/opentelemetry-otlp/#configure-endpoint-port-protocol).
